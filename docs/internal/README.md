...
検証ログ・スナップイン動作確認用の差分ファイル、**サイト構築の生記録**など、**公開サイトのビルド対象外**の資料を置きます。

| ファイル / ディレクトリ | 内容 |
|---|---|
| [`build-log.md`](./build-log.md) | **構築ログ正本** — サイト組み上げ・Cursor/Computer 相談の時系列（ブログネタ素材。記事形式にしない） |
| [`blog-ideas.md`](./blog-ideas.md) | **連載ネタ正本（構築中）** — 想定タイトル・切り口。完成後 hack-plus へ統合 |
...
構築ログの運用ルールは [`docs/OPERATIONS.md`](../OPERATIONS.md) §9。
